...
namespace CefSharp
{
    namespace Internals
    {
        ...
        private:
            ...
            PendingTaskRepository^ _pendingTasks;
            bool _disposed;
            ...
            void DisposedGuard();
        public:
            JavascriptCallbackProxy(JavascriptCallback^ callback, PendingTaskRepository^ pendingTasks, WeakReference^ browserAdapter)
